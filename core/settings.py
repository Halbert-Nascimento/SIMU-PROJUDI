...
# Necessário quando PRIVATE_STORAGE_SERVER=nginx (nosso caso em produção, via
# X-Accel-Redirect no container nginx) — sem isso o modo nginx não serve os
# arquivos. Não necessário para o server Django/DocumentoProcessualServer acima.
